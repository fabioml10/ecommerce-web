        ...
        <BlueBackground>
          <Row>
            ...
            <Col md={4} xs={12} className={styles.product_data}>
              ...
              <Badge bg="primary" className={product_styles.primary_badge}>Ação</Badge>
              <Badge bg="primary" className={product_styles.primary_badge}>Aventura</Badge>
              <Badge bg="primary" className={product_styles.primary_badge}>Indie</Badge>
            </Col>
        ...
        <BlueBackground>
          <Row>
            ...
            <Col md={4} xs={12} className={styles.product_data}>
              ...
              <Badge bg="primary" className={product_styles.primary_badge}>Ação</Badge>
              <Badge bg="primary" className={product_styles.primary_badge}>Aventura</Badge>
              <Badge bg="primary" className={product_styles.primary_badge}>Índie</Badge>
            </Col>
